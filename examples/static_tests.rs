...
use icloud_album_rs::models::{Image, Metadata, Derivative};
...
fn test_parse_api_response() {
    ...
    derivatives1.insert("1".to_string(), Derivative {
    ...
    derivatives1.insert("2".to_string(), Derivative {
    ...
    derivatives2.insert("1".to_string(), Derivative {
...
fn test_parse_asset_urls() {
    ...
    urls.insert("abc123".to_string(), "https://example1.icloud.com/path/to/image1.jpg".to_string());
    urls.insert("def456".to_string(), "https://example2.icloud.com/path/to/image2.jpg".to_string());
    ...
    match &photos[0].derivatives.get("1").unwrap().url {
        Some(url) => {
            assert_eq!(url, "https://example1.icloud.com/path/to/image1.jpg", "URL 1 mismatch");
    ...
    match &photos[1].derivatives.get("1").unwrap().url {
        Some(url) => {
            assert_eq!(url, "https://example2.icloud.com/path/to/image2.jpg", "URL 2 mismatch");
