...
fn run_api_test() -> bool {
    ...
    let output = Command::new("cargo")
        .args(["test", "--test", "api_test", "--", "--ignored", "test_api_response"])
        .output()
    ...
    let output = Command::new("cargo")
        .args(["test", "--test", "api_test", "--", "--ignored", "test_asset_urls"])
        .output()
        .expect("Failed to execute test command");
...
fn run_integration_test() -> bool {
    ...
    // Run cargo test directly
    let output = Command::new("cargo")
        .args(["test", "--test", "integration_test", "--", "--ignored", "test_icloud_photos"])
        .output()
        .expect("Failed to execute test command");
