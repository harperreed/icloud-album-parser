...
fn test_enrich_photos_with_urls() {
    ...
    all_urls.insert("checksum1".to_string(), "https://example.com/image1.jpg".to_string());
    all_urls.insert("checksum2".to_string(), "https://example.com/image2.jpg".to_string());
    all_urls.insert("checksum3".to_string(), "https://example.com/image3.jpg".to_string());
    ...
    assert_eq!(
        photos[1].derivatives.get("2").unwrap().url,
        None
    );
}